...
**$getServerVar[prefix]steal** - Steal the international bank?
**$getServerVar[prefix]give** - Give money to someone.
**$getServerVar[prefix]shop** - Shop. (more command for buying, eating, etc in here!)]

$color[fabdf1]
$image[https://media.discordapp.net/attachments/841445020837478400/863530950464765952/image0.gif]
$footer[Made by mora#1999 | Economy Commands!]
$addTimestamp`
})
